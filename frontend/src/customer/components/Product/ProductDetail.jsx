      ...
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-wrap space-x-5 justify-center pt-2">
              {product.images.map((data) => {
                return (
                  <div className="aspect-h-2 aspect-w-3 mt-2 overflow-hidden rounded-lg max-w-[5rem] max-h-[5rem]">
                    <img
                      src={data.src}
                      alt={data.alt}
                      className="h-full w-full object-cover object-center"
                        ...
                        <RadioGroup.Option
                          ...
                          className={({ active }) =>
                            classNames(
                              ...
                              "group relative flex items-center justify-center rounded-md border py-1 px-2 text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none sm:flex-1 sm:py-4 "
                            )
                          }
                        >
                          {({ active, checked }) => (
